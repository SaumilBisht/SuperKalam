...
const firstColumn=testimonials.splice(0,3);
const secondColumn=testimonials.splice(3,6);
const thirdColumn=testimonials.splice(6,9);
...
const TestimonialsColumn=( props: {
  ...
  return(
    <div className={props.className}>
      ...
      <motion.div className="flex flex-col gap-6 pb-2 -translate-y-1/2"
      animate={{
        translateY:"-50%"
      }}
      transition={{
      ...
      >
        {[...new Array(2)].fill(0).map((_,index)=> (
          <React.Fragment key={index}>
              ...
              <div className="card" key={name + username + index}>
    ...
    <section className="bg-white">
      <div className="container">
        ...
        <div className="flex justify-center gap-6 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] mt-10 max-h-[780px] overflow-hidden">
          ...
          <TestimonialsColumn testimonials={secondColumn} className="hidden lg:block" duration={15}/>
        </div>
      </div>
    </section>
  );
